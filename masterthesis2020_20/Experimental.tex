...
\begin{figure}%
    \centering
    \subfloat{{\includegraphics[width=12cm]{Experiment/Det1-6_rel_unc.png} }}%
    
    \subfloat{{\includegraphics[width=12cm]{Experiment/rel_unc_room131.png} }}%
