...
\begin{figure}%
    \centerin    \subfloat{{\includegraphics[width=8cm]{Results/Fe_56Co.png} }}%
    %\subcaption{....}
    \quad
...
\begin{figure}%
    \centering
    \subfloat{{\includegraphics[width=5cm]{Results/Ir_188Pt.png}}%
    \quad
    \subfloat[]{{\includegraphics[width=5cm]{Results/Ir_188Ir.png} }}%
    \subfloat[]{{\includegraphics[width=5cm]{Results/Ir_189Pt.png} }}%
    \quad
    \subfloat[]{{\includegraphics[width=5cm]{Results/Ir_189Ir.png} }}%
    \quad
    \subfloat[]{{\includegraphics[width=5cm]{Results/Ir_190Ir.png} }}%
    \quad
    \subfloat[caption]{{\includegraphics[width=5cm]{Results/Ir_191Pt.png} }}%
    \quad
    \subfloat[]{{\includegraphics[width=5cm]{Results/Ir_192Ir.png} }}%
    \quad
    \subfloat[]{{\includegraphics[width=5cm]{Results/Ir_193mPt.png} }}%
    \quad
